...
local indicator = "Interface\\AddOns\\oUF_Dimglass\\media\\squares.ttf"
local symbols = "Interface\\AddOns\\oUF_Dimglass\\media\\PIZZADUDEBULLETS.ttf"
...
local Enable = function(self)
    if(self.freebIndicators) then
        ...
        self.AuraStatusTL:SetFont(indicator, 8, "OUTLINE")
        ...
        self.AuraStatusTR:SetFont(indicator, 8, "OUTLINE")
        ...
        self.AuraStatusBL:SetFont(indicator, 8, "OUTLINE")
        ...
        self.AuraStatusBR:SetFont(symbols, 12, "OUTLINE")
        ...
        self.AuraStatusCen:SetFont(GameTooltipText:GetFont(), 12, "OUTLINE")
