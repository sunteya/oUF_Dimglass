...
--media
cfg.statusbar_texture = "Interface\\AddOns\\oUF_Dimglass\\media\\statusbar"
cfg.powerbar_texture = "Interface\\AddOns\\oUF_Dimglass\\media\\statusbar"
...
cfg.Runebar = true 						-- show DK rune bar
cfg.Holybar = true 						-- show Paladin HolyPower bar
cfg.Eclipsebar = true 					-- show Druid Eclipse bar
cfg.WarlockSpecBars = true 				-- show WarlockSpecBars bar
cfg.TotemBars = true					-- show Shaman Totem bar
cfg.ShadowOrbsBar = true				-- show ShadowOrbs Bar
